...
export function legacyComponentToAction(moduleKey: string, component: string): string | null {
  ...
  const maps: Record<string, Record<string, string>> = {
    ...
    vistorias: { btnPesquisar: 'pesquisar', btnCarregar: 'carregarObra', btnCarregarVistoria: 'carregar', btnCarregarFicha: 'carregarFicha', btnArquivosFotos: 'arquivosFotos', btnEnvio: 'envio', btnSolicitaAditivo: 'solicitaAditivo', btnLancaFollowUp: 'lancaFollowUp', btnVoltar: 'navigate:main' },
